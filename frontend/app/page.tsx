...
const Page = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh)] px-4 text-center">
      <div className="font-semibold text-gray-900 z-10 transform -translate-y-13">
        <div className="font-semibold text-xl sm:text-2xl lg:text-3xl xl:text-4xl">백지에서 시작하는 진정한 학습,</div>
        <div className="font-semibold text-xl sm:text-2xl lg:text-3xl xl:text-4xl mt-1 sm:mt-2 lg:mt-4 mb-2 sm:mb-3 lg:mb-4">TABULA와 함께하세요!</div>
      </div>
      <div className="mt-4 text-gray-500 z-10 transform -translate-y-13 text-sm sm:text-base lg:text-md
                      max-w-xs sm:max-w-md lg:max-w-2xl">
        틀린 부분과 부족한 부분에 대한 맞춤 피드백을 제공하여 쉽게 백지학습을 할 수 있도록 도와줍니다.
      </div>
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 mt-8 z-10 transform -translate-y-13">
