  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh)] px-4 text-center relative">
      <div className="font-semibold text-gray-900 z-10 transform">
        <div className="font-semibold text-xl sm:text-2xl md:text-3xl xl:text-4xl">백지에서 시작하는 진정한 학습,</div>
        <div className="font-semibold text-xl sm:text-2xl md:text-3xl xl:text-4xl mt-1 sm:mt-2 lg:mt-4 mb-2 sm:mb-3 lg:mb-4">TABULA와 함께하세요!</div>
      </div>
      <div className="mt-4 text-gray-500 z-10 transformtext-sm sm:text-base lg:text-md
