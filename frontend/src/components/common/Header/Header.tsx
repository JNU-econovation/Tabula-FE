      ...
      <div className='flex items-center gap-9'>
        ...
        {isLogin && username ? (
          <div className='text-[#292929] mr-5'>{username}님</div>
            ...
            <Link href='login'>
              <button className='cursor-pointer bg-[#E7EAFF] px-5 py-2 rounded-full text-sm text-[#292929] hover:bg-[#d6d9f7] transition-all duration-300 hover:scale-103'>로그인</button>
            </Link>
          )
        }
      </div>
